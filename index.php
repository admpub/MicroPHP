 ...
 */
$system['application_folder'] = FRAMEWORK_PATH . '/' . 'application';
/**
 * 存放控制器文件的文件夹路径名称
 */
 ...
 */
$system['controller_file_suffix'] = '.php';
/**
 * 模型文件名称后缀,比如.model.php
 */
$system['model_file_suffix'] = '.model.php';
/**
 * 视图文件名称后缀,比如.view.php
 */
$system['view_file_suffix'] = '.view.php';
/**
...
$system['db']['default']['password'] = 'root';
$system['db']['default']['database'] = 'erp';
$system['db']['default']['dbprefix'] = 'swh_';
